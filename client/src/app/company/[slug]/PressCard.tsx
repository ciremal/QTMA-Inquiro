...
export default function PressCard({article}: PressCardProps){
    ...
    return (
        <div className="flex-shrink-0 basis-[calc(33.333%-1rem)] border rounded-lg shadow-lg">
            <img src={thumbnailUrl} alt="thumbail" className="rounded-t-lg object-cover object-center w-full h-1/3 mb-4"/>
            <div className="px-4">
                ...
                <Link href={link} className="block text-right text-cyan-600 mt-auto hover:underline">
                    Read More
