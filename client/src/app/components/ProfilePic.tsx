  ...
  return (
    <>
      <div className="relative w-sm">
        ...
        <div
          className={`flex items-center justify-between backdrop-blur-md bg-secondaryBlack p-2 rounded-3xl border border-primaryGray cursor-pointer transition-all duration-300 ${
        ...
        >
          <div className="flex items-center">
            ...
            <p className="ml-4 font-sans text-white text-center my-auto max-w-[85px] truncate">
        ...
        >
          <div className="bg-secondaryBlack border border-t-0 border-primaryGray rounded-b-3xl">
            <button
            ...
            <button
              className="w-full text-left px-4 py-2 hover:bg-gray-700 text-white rounded-b-3xl"
